		...
		<view class="login-form">
			<form @submit="login">
				<view class="form-input">
					<input v-model="form.username" type="text" value="" placeholder="用户名" />
				</view>
				<view class="form-input">
					<input v-model="form.password" type="password" value="" placeholder="密码" @focus="passwordF_B" @blur="passwordF_B" />
				</view>
...
<script>
	...
	import User from '@/lin/model/user.js'
		...
		methods: {
			...
			async getInformation() {
				try {
					...
					// return this.setUserAndState(user);
